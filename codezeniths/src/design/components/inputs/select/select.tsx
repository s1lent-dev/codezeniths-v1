...
function SelectTrigger({
    ...
    return (
        <SelectPrimitive.Trigger
            ...
            data-size={size}
            className={cn(
                "text-body-light dark:text-body-dark border-secondary data-placeholder:text-secondary bg-background-light dark:bg-foreground-dark hover:bg-background-light-shade3 dark:hover:bg-foreground-dark-shade3 focus-visible:border-none dark:focus-visible:border-none focus-visible:ring-none dark:focus-visible:ring-none aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50 gap-sm-2 rounded-lg border py-sm-2 pr-sm-2 pl-md-1 text-p transition-colors select-none focus-visible:ring-3 aria-invalid:ring-3 data-[size=default]:h-lg-2 data-[size=sm]:h-xl-1 data-[size=sm]:rounded-[min(var(--radius-md),10px)] *:data-[slot=select-value]:gap-sm-2 [&_svg:not([class*='size-'])]:size-4 flex w-fit items-center justify-between whitespace-nowrap outline-none disabled:cursor-not-allowed disabled:opacity-50 *:data-[slot=select-value]:line-clamp-1 *:data-[slot=select-value]:flex *:data-[slot=select-value]:items-center [&_svg]:pointer-events-none [&_svg]:shrink-0",
                className,
            )}
            {...props}
        >
