...
export const FavouritesCardSkeleton: React.FC = () => (
    <div className={`${CARD} p-6 sm:p-7 flex flex-col justify-between space-y-6 h-full min-h-120`}>
        <div className="space-y-4">
            {/* Top row: Star icon box */}
            <div className="flex items-center justify-between gap-4">
                <div className={`${BONE} size-10 rounded-md`} />
            </div>
...
export const SingleFavouritesPageSkeleton: React.FC = () => (
