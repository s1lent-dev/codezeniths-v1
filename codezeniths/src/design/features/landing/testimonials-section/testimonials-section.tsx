...
export const TestimonialsSection = () => {
    ...
    return (
        <section ref={sectionRef} className="py-24 mt-6 relative bg-background-light dark:bg-background-dark overflow-hidden">
            <Container size="5xl" className="mx-auto px-6 lg:px-8 relative z-10">
                ...
                >
                    ...
                    className="w-full max-w-7xl mx-auto relative px-4 md:px-0"
                >
                        ...
                        {TESTIMONIALS.map((testimonial, i) => (
                            <CarouselItem key={i} className="pl-6 basis-full md:basis-1/2">
                                <Card
                                    ...
                                    className="p-6 md:p-8 h-full flex flex-col justify-start bg-foreground-light dark:bg-foreground-dark border border-secondary rounded-2xl cursor-grab select-none"
                                >
                                    <CardHeader padded={false} className="flex flex-row items-center justify-between mb-8 pb-6 p-0 w-full">
                                        <div className="flex flex-col gap-1">
                                            <CardTitle className="font-semibold text-xl text-body-light dark:text-body-dark m-0">
                                                {testimonial.name}
                                            </CardTitle>
                                            <CardDescription className="text-sm text-muted-light dark:text-muted-dark m-0">
                                                {testimonial.handle}
                                            </CardDescription>
                                        </div>
                                        <div className="w-14 h-14 rounded-full overflow-hidden shrink-0 bg-muted-light dark:bg-muted-dark relative">
                                            <Image
                                    ...
                                    <CardContent className="text-body-light/80 dark:text-muted-dark text-[0.875rem] leading-relaxed w-[90%] line-clamp-3 p-0">
                                        {testimonial.content}
                                    </CardContent>
                                </Card>
                            </CarouselItem>
