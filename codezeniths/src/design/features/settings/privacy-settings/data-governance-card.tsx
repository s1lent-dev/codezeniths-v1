    ...
    if (isLoading) {
        return (
            <Card className="w-full p-4.5 xs:p-6 sm:p-8 rounded-md border border-foreground-light-shade3 dark:border-foreground-dark-shade1 ring-0 bg-foreground-light dark:bg-foreground-dark shadow-xs space-y-6 sm:space-y-7 relative overflow-hidden select-none font-sans group">
                ...
                <div className="space-y-3.5 sm:space-y-4 pt-4 sm:pt-6 relative z-10">
                    {[0, 1, 2].map((idx) => (
                        <div
                            key={idx}
                            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-3.5 sm:p-4.5 rounded-md bg-foreground-light-shade1/60 dark:bg-foreground-dark-shade1/40 border border-foreground-light-shade3/60 dark:border-foreground-dark-shade1/60"
                        >
                            <div className="flex items-center gap-3 sm:gap-3.5 min-w-0 flex-1">
                                ...
                                <div className="space-y-1.5 min-w-0 flex-1">
                                    <motion.div
                                        ...
                                        className="h-4 w-40 rounded bg-foreground-light-shade3 dark:bg-foreground-dark-shade3"
                                    />
                                    <motion.div
                                        animate={{ opacity: [0.35, 0.75, 0.35] }}
