                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-5 sm:gap-6 relative z-10">
                    ...
                    <div className="flex items-center gap-4 xs:gap-5 sm:gap-6 min-w-0">
                        <motion.div
                            ...
                            className="size-14 xs:size-16 sm:size-18 rounded-md bg-teal/15 dark:bg-teal/25 shrink-0"
                        />
                        <div className="space-y-2.5 min-w-0 flex-1">
                            <div className="flex items-center gap-2">
                                ...
                                <motion.div
                                    ...
                                    className="h-5 w-24 rounded-full bg-teal/15 dark:bg-teal/25 hidden sm:block"
                                />
                            </div>
                            <motion.div
                                animate={{ opacity: [0.35, 0.75, 0.35] }}
