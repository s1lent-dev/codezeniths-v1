                        ...
                        >
                            <div className="flex items-center gap-3.5 min-w-0 flex-1">
                                <motion.div
                                    ...
                                    className="size-9 rounded-sm bg-primary/15 dark:bg-primary/25 shrink-0"
                                />
                                <div className="space-y-1.5 min-w-0 flex-1">
                                    ...
                                    <motion.div
                                        ...
                                        className="h-4 w-40 xs:w-48 rounded bg-foreground-light-shade3 dark:bg-foreground-dark-shade3"
                                    />
                                </div>
                            </div>
                            <motion.div
                                ...
                                className="size-8 rounded-full bg-primary/15 dark:bg-primary/25 shrink-0 self-end sm:self-center"
                            />
                        </div>
                    ))}
                </div>
