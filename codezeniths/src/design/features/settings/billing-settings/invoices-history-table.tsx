            ...
            <Card className="w-full p-4.5 xs:p-6 sm:p-8 rounded-md border border-foreground-light-shade3 dark:border-foreground-dark-shade1 ring-0 bg-foreground-light dark:bg-foreground-dark shadow-xs space-y-6 sm:space-y-7 relative overflow-hidden select-none font-sans group">
                ...
                <div className="space-y-3 pt-6 relative z-10">
                    {[0, 1, 2].map((idx) => (
                        <div
                            key={idx}
                            className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4.5 rounded-md bg-foreground-light-shade1/60 dark:bg-foreground-dark-shade1/40 border border-foreground-light-shade3/60 dark:border-foreground-dark-shade1/60"
                        >
                            <div className="flex items-center gap-3.5 min-w-0 flex-1">
                                ...
                                <div className="space-y-1.5 min-w-0 flex-1">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <motion.div
                                            animate={{ opacity: [0.35, 0.75, 0.35] }}
                                            transition={{ duration: 1.5, repeat: Infinity, ease: 'easeInOut', delay: 0.1 + idx * 0.06 }}
                                            className="h-4 w-14 rounded-full bg-emerald-500/15 dark:bg-emerald-500/25"
                                        />
                                    </div>
                                    <motion.div
                                        animate={{ opacity: [0.35, 0.75, 0.35] }}
                            ...
                            <div className="flex items-center gap-4 shrink-0">
                                ...
                                <motion.div
                                    ...
                                    className="h-8 w-28 rounded-sm bg-primary/15 dark:bg-primary/25"
                                />
                            </div>
                        </div>
                    ))}
