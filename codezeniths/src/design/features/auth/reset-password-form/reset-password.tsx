...
export const ResetPassword = () => {
    return (
        <Section className="relative w-full flex-1 my-auto flex flex-col items-center justify-center py-6 xs:py-8 sm:py-12 md:py-16 bg-background-light dark:bg-background-dark overflow-visible mt-20">
            <Container size="xl" className="mx-auto px-2 xs:px-3 sm:px-6 lg:px-8 relative w-full h-full flex items-center justify-center">
                <motion.div
                    variants={{
                ...
                >
                    ...
                    >
                        <Suspense fallback={<div className="flex items-center justify-center h-100">Loading...</div>}>
                            <ResetPasswordForm />
                        </Suspense>
                    </motion.div>
                </motion.div>
