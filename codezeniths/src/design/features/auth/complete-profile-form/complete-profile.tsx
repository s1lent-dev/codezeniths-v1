...
export const CompleteProfile = () => {
    return (
        <Section className="relative w-full min-h-dvh flex flex-col items-center justify-center py-24 bg-background-light dark:bg-background-dark overflow-visible mt-24">
            <Container size="3xl" className="mx-auto px-6 lg:px-8 relative w-full h-full flex items-center justify-center">
                <motion.div
                    variants={{
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="absolute top-0 left-0 right-0 h-[75%] rounded-[1.25rem] bg-foreground-light-shade3/75 dark:bg-foreground-dark-shade3/75 mask-[linear-gradient(to_bottom,white_40%,transparent_100%)] z-0"
                    />

                    {/* Dotted Background */}
                    <div className="absolute left-0 right-0 top-[25%] bottom-0 z-0 pointer-events-none rounded-[2.5rem] ">
                        <Background
