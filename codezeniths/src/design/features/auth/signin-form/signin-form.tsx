...
export const SigninForm = () => {
    ...
    return (
        <Card variant={CardVariant.FLAT} className="relative w-[95%] md:w-[80%] sm:w-[75%] max-w-6xl p-8 md:p-16 border border-secondary rounded-2xl bg-foreground-light dark:bg-foreground-dark mx-auto lg:mt-12 md:mt-8 sm:mt-4 shadow-none">
            ...
            <CardContent className="p-0 w-full flex flex-col gap-6">
                ...
                >
                    ...
                    <div className="relative flex flex-col-reverse sm:flex-row items-center justify-center w-full gap-6 sm:gap-0 pt-4">
                        <div className="sm:absolute sm:left-0 flex items-center gap-3 w-full sm:w-auto justify-center sm:justify-start">
                            ...
                            />
                            <Typography variant={TypographyVariant.SPAN} className="text-sm font-medium text-muted-light dark:text-muted-dark">
                        ...
                        {loginMethod === 'credentials' ? (
                            ...
                            <Button
                                ...
                                disabled={!turnstileToken}
                                className="w-full sm:w-auto h-14 px-12 text-foreground-dark dark:text-foreground-light-shade3 shadow-md"
                            >
                    ...
                    <Container direction="row" align="center" justify="between" size="none" padded={false} centered={false} className="w-full mt-2 flex-col sm:flex-row gap-4">
                        <Link href="/forgot-password" className="text-sm text-heading-light dark:text-heading-dark font-medium hover:underline text-left">
                            Forgot password?
                        </Link>
