...
import { ResumeModuleCardSkeleton } from './resume-module-card-skeleton';
...
export interface ResumeModuleCardProps {
...
export const ResumeModuleCard: React.FC<ResumeModuleCardProps> = ({
    recentModuleData,
    featuredModuleData,
    isLoading = false,
    className,
    ...
    if (isLoading) {
        return <ResumeModuleCardSkeleton className={className} />;
    }
